...
import type { TrailLessonType, TrailModule } from '../../../types/tracks'
...
function getModuleStatus(module: TrailModule): ModuleStatus {
  ...
  if (progress >= 100 && module.lessons > 0) return 'completed'
    ...
    <section className="trail-modules-panel" aria-labelledby="trail-modules-title">
      ...
      <div className="trail-modules-list">
        {modules.map((module, index) => {
          ...
          const videoCount = countLessonsByType(module, 'VIDEO') || module.lessons
          ...
          return (
            <details className="trail-module-card" key={module.id} open={index === 0}>
              <summary className="trail-module-card__summary">
                ...
                <span className="trail-module-card__content">
                  ...
                  <span className="trail-module-card__progress-copy">
                    <strong>{module.completedLessons}/{module.lessons}</strong>
                    <span>aulas</span>
                ...
                <span
                  ...
                  aria-hidden="true"
                >
                  {status === 'completed' ? <Check size={18} strokeWidth={2.4} /> : null}
